...
<body style="background-image: linear-gradient(to top ,#1A2980, #26D0CE);width:100%;">
...
<?php
        ...
        $q = "select * from service where servicename='QP' && branch='AU'"; //edited here
        
        $r = mysqli_query($db,$q);
        $i=1;
        echo "<h3 class='title1'>automobile branch Question paper</h3>";
        while($d = mysqli_fetch_assoc($r)){
            $file = $d['file'];
...
<?php
        ...
        $q = "select * from service where servicename='QP' && branch='ME'"; //edited here
        
        $r = mysqli_query($db,$q);
        $i=1;
        echo "<h3 class='title1'>mechanical branch Question paper</h3>";
