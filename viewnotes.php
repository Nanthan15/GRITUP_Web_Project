...
?>
    ...
    <?php
        ...
        $q = "select * from service where servicename='notes' and branch='CS'";
        $r = mysqli_query($db,$q);
        $i=1;
    ...
    <?php
        ...
        $q = "select * from service where servicename='notes' and branch='EC'";
        $r = mysqli_query($db,$q);
        $i=1;
        echo "<h3 class='title1'>Electronics and communication branch</h3>";
        while($d = mysqli_fetch_assoc($r)){
            $file = $d['file'];
            echo "<div class='container'>";
            echo "<div class='card' style='width: 22rem;padding:10px;float:left;margin-left:20px;margin-bottom:15px;line-height:30px'>";
    ...
    <?php
        ...
        $q = "select * from service where servicename='notes' and branch='AU'";
        $r = mysqli_query($db,$q);
        $i=1;
        echo "<h3 class='title1'>Automobile Branch</h3>";
        while($d = mysqli_fetch_assoc($r)){
            $file = $d['file'];
            echo "<div class='container'>";
            echo "<div class='card' style='width: 22rem;padding:10px;float:left;margin-left:20px;margin-bottom:15px;line-height:30px'>";
    ...
    <?php
        ...
        $q = "select * from service where servicename='notes' and branch='ME'";
        $r = mysqli_query($db,$q);
        $i=1;
        echo "<h3 class='title1'>Mechnical Branch</h3>";
        while($d = mysqli_fetch_assoc($r)){
            $file = $d['file'];
            echo "<div class='container'>";
            echo "<div class='card' style='width: 22rem;padding:10px;float:left;margin-left:20px;margin-bottom:15px;line-height:30px'>";
